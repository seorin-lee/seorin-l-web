...
export default function Navigation() {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      href: 'https://github.com/seorin-lee',
      label: 'GitHub',
      color: 'from-black to-black',
    },
  ];
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 px-4 py-4 md:px-8">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        {/* Left: App-style Navigation Icons */}
        <motion.div
        ...
        >
          {socialLinks.map((social, idx) => (
            ...
            >
              <div
                className={`glass rounded-full p-2 md:p-3 jelly-hover shadow-lg hover:shadow-xl transition-all bg-gradient-to-br ${social.color}`}
              >
